...
#define DAC_PA_MUTE_INIT()                                                              \
    {                                                                                   \
        hal_gpioInit(DAC_PA_MUTE_CH, DAC_PA_MUTE_PIN, GPIO_OUTPUT, GPIO_PULL_FLOATING); \
    }
#define DAC_PA_MUTE_OFF()                                          \
    {                                                              \
        hal_gpioWrite(DAC_PA_MUTE_CH, DAC_PA_MUTE_PIN, GPIO_HIGH); \
    } // have sound
#define DAC_PA_MUTE_ON()                                          \
    {                                                             \
        hal_gpioWrite(DAC_PA_MUTE_CH, DAC_PA_MUTE_PIN, GPIO_LOW); \
    } // no sound
#else
//==need to set ax32xx_dac.c  ax32xx_dacInit(void)
...
#define FRONT_SENSOR_RESET_CH GPIO_PF
#define FRONT_SENSOR_RESET_PIN GPIO_PIN10

#define REAR_SENSOR_RESET_CH GPIO_PF
#define REAR_SENSOR_RESET_PIN GPIO_PIN11
